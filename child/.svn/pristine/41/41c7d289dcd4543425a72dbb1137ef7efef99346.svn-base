...
angular.module('App').controller('MessageTemplateCtrl', function($rootScope, $stateParams, $scope, $ajax, $uibModal) {
    ...
    $scope.currentTab = 'message.template';
    ...
    $scope.load = function() {
        ...
        $ajax.post('/api-child/ordinary/Template/items',$.param(data),function (result) {
            // alert(result);
    ...
    $scope.loadSignJk = function() {
        $ajax.post('/api-child/ordinary/Signature/items', $.param({username: username,limit:100}), function(result) {
    ...
    $scope.delete = function (id) {
        layer.msg('你确定删除该模板吗？', {
            ...
            yes: function(index){
                layer.close(index);
                $ajax.post('/api-child/ordinary/Template/remove',$.param({id: id}) , function () {
...
angular.module('App').controller('MessageTemplateEditCtrl', function($rootScope, $stateParams, $scope, $ajax, $uibModalInstance, data) {
    ...
    $scope.ok = function () {
        ...
        $ajax.post('/api-child/ordinary/Template/add', $.param($scope.data), function (result) {
