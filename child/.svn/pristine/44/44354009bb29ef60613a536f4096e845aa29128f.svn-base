...
angular.module('App').controller('MessageEarlierCtrl', function($rootScope, $stateParams, $scope, $ajax ,$filter ,$uibModal ,$state) {
    ...
    $scope.currentTab2 = 'message.record.earlier';
    ...
    $scope.load = function() {
        ...
        $ajax.post('/api-child/bridge2/DownAll/items/',$.param(data),function (result) {
            // alert(result);
            // console.log(result)
    ...
    $scope.loadHistoryList = function () {
        ...
        $ajax.post('/api-child/bridge2/DownExport/query/',$.param(downData),function (result) {
