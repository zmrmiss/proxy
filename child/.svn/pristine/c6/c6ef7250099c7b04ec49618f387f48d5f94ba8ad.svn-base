 ...
 */
angular.module('App').controller('MessageReplyEarlierCtrl', function($rootScope, $stateParams, $scope, $ajax,$uibModal,$filter ) {

    $scope.currentTab = 'message.reply.today';
    $scope.currentTab2 = 'message.reply.earlier';
    ...
    $scope.load = function() {
        ...
        $ajax.post('/api-child/bridge2/ReplyAll/items',$.param(data),function (result) {
            // alert(result);
            // console.log(result)
