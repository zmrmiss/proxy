 ...
 *
 */
angular.module('App').controller('MessageIndustryRecordYesterdayCtrl', function($rootScope, $stateParams, $scope, $ajax,$state) {

    $scope.currentTab = 'industry.record.today';
    $scope.currentTab2 = 'industry.record.yesterday';
    ...
    $scope.load = function() {
        var data={page:$scope.paginationConf.currentPage,limit: 10, telephone:$scope.params.telephone, username:apindustry,day:'-1',scope:1};
