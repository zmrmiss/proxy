 ...
 * Created by zhangm
 */
angular.module('App').controller('MessagePlatIndivSendCtrl', function($rootScope, $stateParams, $uibModal, $scope, $ajax, FileUploader, $uibModal,$filter) {
    $scope.HtmlRen = true;
