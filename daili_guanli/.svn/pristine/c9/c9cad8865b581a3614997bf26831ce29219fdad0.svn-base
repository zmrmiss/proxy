 ...
 *
 */
angular.module('App').controller('DlAccountPwdEditCtrl', function($rootScope, $scope, $ajax) {
        ...
        $('.form-horizontal').validate({
            ...
            submitHandler: function() {
                ...
                layer.msg('你确定修改密码吗？', {
                    ...
                    yes: function(index){
                        layer.close(index);
                        $ajax.post('/api/center/Center/changePasswd/',$.param({
                            old_password: $scope.data.password,
