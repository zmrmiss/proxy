 ...
 *
 */
angular.module('App').controller('DistributionRecordCtrl', function($rootScope, $stateParams, $scope, $ajax , $filter) {

    $scope.currentTab = 'orders.distribution';
    ...
    $scope.load = function() {
        ...
        $ajax.post('/api/recharge/Bill/items/', $.param({
